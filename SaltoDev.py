...
def dump_massal():
	try:
	    ...
	    exit()
	try:
		kumpulkan = int(input('\x1b[0m[\x1b[1;92m+\x1b[0m] Mau Berapa Target Cui : '))
	except ValueError:
	    exit()
	...
	for KOTG49H in range(kumpulkan):
		bilangan+=1
		Masukan = input(f'\x1b[0m[\x1b[1;92m+\x1b[0m] Masukkan ID Yang Ke '+str(bilangan)+f' : ')
		uid.append(Masukan)
	for user in uid:
	    try:
	       head = (
	      ...
	      pass
	        ...
	        exit()
	try:
	      print("\x1b[0m[\x1b[1;92m+\x1b[0m] Total ID Terkumpul : "+str(len(id))) 
	      setting()
	except requests.exceptions.ConnectionError:
	    exit()
	except (KeyError,IOError):
